...
DIL<- read_csv2('data/5/DIL.csv')
Boost <- read_csv2('data/5/Boost.csv')
Rectum <- read_csv2('data/5/Rectum.csv')
Bladder <- read_csv2('data/5/Bladder.csv')
XVI <- read_csv2('data/5/XVI.csv')
```
