...
DIL<- read_csv2('data/18/DIL.csv')
Boost <- read_csv2('data/18/Boost.csv')
Rectum <- read_csv2('data/18/Rectum.csv')
Bladder <- read_csv2('data/18/Bladder.csv')
XVI <- read_csv2('data/18/XVI.csv')
```
