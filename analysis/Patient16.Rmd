...
DIL<- read_csv2('data/16/DIL.csv')
Boost <- read_csv2('data/16/Boost.csv')
Rectum <- read_csv2('data/16/Rectum.csv')
Bladder <- read_csv2('data/16/Bladder.csv')
XVI <- read_csv2('data/16/XVI.csv')
```
