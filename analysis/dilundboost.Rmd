...
par(mar = c(5, 5, 2, 2)) # Abstände um den Plot. 2. Po´ition y-Achse
par(mgp=c(3,1,0)) # mpg: Abstand Label zu Achse
hist(DIL_mean_rel_table, 
    main="",
    #DIL Mittelwert" 
     ylab="Density", xlab="Dosis in Gray", mgp=c(3,1,0), las = 1, freq = FALSE, ylim=c(0, 2), xlim=c(), cex.lab=2, cex.axis=1.5, col = "transparent")
rug(jitter(DIL_mean_rel_table))
lines(density(DIL_mean_rel_table), col="black", lwd=2)
