...
DIL<- read_csv2('data/4/DIL.csv')
Boost <- read_csv2('data/4/Boost.csv')
Rectum <- read_csv2('data/4/Rectum.csv')
Bladder <- read_csv2('data/4/Bladder.csv')
XVI <- read_csv2('data/4/XVI.csv')
```
