...
```{r DIL Mittelwert, width=400, height=350, dev=c('png', 'pdf'), echo = FALSE}
library(ggplot2)
#library(scales)
...
```{r  DIL Mittelwert farbige constraints, width=400, height=350, dev=c('png', 'pdf'), echo = FALSE}
library(ggplot2)
...
```{r DIL D99, width=400, height=350, dev=c('png', 'pdf'), echo = FALSE}
library(ggplot2)
library(cowplot)
