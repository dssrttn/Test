...
DIL<- read_csv2('data/14/DIL.csv')
Boost <- read_csv2('data/14/Boost.csv')
Rectum <- read_csv2('data/14/Rectum.csv')
Bladder <- read_csv2('data/14/Bladder.csv')
XVI <- read_csv2('data/14/XVI.csv')
```
