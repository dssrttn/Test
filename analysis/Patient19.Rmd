...
DIL<- read_csv2('data/19/DIL.csv')
Boost <- read_csv2('data/19/Boost.csv')
Rectum <- read_csv2('data/19/Rectum.csv')
Bladder <- read_csv2('data/19/Bladder.csv')
XVI <- read_csv2('data/19/XVI.csv')
```
