...
DIL<- read_csv2('data/2/DIL.csv')
Boost <- read_csv2('data/2/Boost.csv')
Rectum <- read_csv2('data/2/Rectum.csv')
Bladder <- read_csv2('data/2/Bladder.csv')
XVI <- read_csv2('data/2/XVI.csv')
```
