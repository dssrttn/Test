...
DIL<- read_csv2('data/6/DIL.csv')
Boost <- read_csv2('data/6/Boost.csv')
Rectum <- read_csv2('data/6/Rectum.csv')
Bladder <- read_csv2('data/6/Bladder.csv')
XVI <- read_csv2('data/6/XVI.csv')
```
