...
DIL<- read_csv2('data/20/DIL.csv')
Boost <- read_csv2('data/20/Boost.csv')
Rectum <- read_csv2('data/20/Rectum.csv')
Bladder <- read_csv2('data/20/Bladder.csv')
XVI <- read_csv2('data/20/XVI.csv')
```
