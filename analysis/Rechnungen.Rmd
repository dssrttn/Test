...
interval <- cut(DIL_tidy$Mittelwert, c(-Inf, 76.23, 76.23*1.01, 76.23*1.02, 76.23*1.03, 76.23*1.04, 76.23*1.05, Inf), labels=1:7)
#table(interval)
...
interval%>% group_by(interval, .drop = FALSE) %>% 
  summarise(n=n())
