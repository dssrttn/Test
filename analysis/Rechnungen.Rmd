...
Range <- cut(DIL_tidy$Mittelwert, c(-Inf, 76.23, 76.23*1.01, 76.23*1.02, 76.23*1.03, 76.23*1.04, 76.23*1.05, Inf), labels=1:7) # benutzt dplyr, 7 Intervalle 
...
class(Range)
Range
Range %>% group_by(Range, .drop = FALSE) %>% #.drop = FALSE ansonsten Fehlermeldung
# dplyr::count(n=n())
