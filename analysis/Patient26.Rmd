...
DIL<- read_csv2('data/26/DIL.csv')
Boost <- read_csv2('data/26/Boost.csv')
Rectum <- read_csv2('data/26/Rectum.csv')
Bladder <- read_csv2('data/26/Bladder.csv')
XVI <- read_csv2('data/26/XVI.csv')
```
