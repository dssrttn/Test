...
DIL<- read_csv2('data/17/DIL.csv')
Boost <- read_csv2('data/17/Boost.csv')
Rectum <- read_csv2('data/17/Rectum.csv')
Bladder <- read_csv2('data/17/Bladder.csv')
XVI <- read_csv2('data/17/XVI.csv')
```
