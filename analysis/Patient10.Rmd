...
DIL<- read_csv2('data/10/DIL.csv')
Boost <- read_csv2('data/10/Boost.csv')
Rectum <- read_csv2('data/10/Rectum.csv')
Bladder <- read_csv2('data/10/Bladder.csv')
XVI <- read_csv2('data/10/XVI.csv')
```
