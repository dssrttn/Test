...
DIL<- read_csv2('data/3/DIL.csv')
Boost <- read_csv2('data/3/Boost.csv')
Rectum <- read_csv2('data/3/Rectum.csv')
Bladder <- read_csv2('data/3/Bladder.csv')
XVI <- read_csv2('data/3/XVI.csv')
```
