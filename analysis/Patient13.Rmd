...
DIL<- read_csv2('data/13/DIL.csv')
Boost <- read_csv2('data/13/Boost.csv')
Rectum <- read_csv2('data/13/Rectum.csv')
Bladder <- read_csv2('data/13/Bladder.csv')
XVI <- read_csv2('data/13/XVI.csv')
```
