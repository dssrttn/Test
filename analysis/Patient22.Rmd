...
DIL<- read_csv2('data/22/DIL.csv')
Boost <- read_csv2('data/22/Boost.csv')
Rectum <- read_csv2('data/22/Rectum.csv')
Bladder <- read_csv2('data/22/Bladder.csv')
XVI <- read_csv2('data/22/XVI.csv')
```
