...
DIL<- read_csv2('data/8/DIL.csv')
Boost <- read_csv2('data/8/Boost.csv')
Rectum <- read_csv2('data/8/Rectum.csv')
Bladder <- read_csv2('data/8/Bladder.csv')
XVI <- read_csv2('data/8/XVI.csv')
```
