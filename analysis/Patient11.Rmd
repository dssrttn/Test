...
DIL<- read_csv2('data/11/DIL.csv')
Boost <- read_csv2('data/11/Boost.csv')
Rectum <- read_csv2('data/11/Rectum.csv')
Bladder <- read_csv2('data/11/Bladder.csv')
XVI <- read_csv2('data/11/XVI.csv')
```
