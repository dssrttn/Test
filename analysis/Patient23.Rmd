...
DIL<- read_csv2('data/23/DIL.csv')
Boost <- read_csv2('data/23/Boost.csv')
Rectum <- read_csv2('data/23/Rectum.csv')
Bladder <- read_csv2('data/23/Bladder.csv')
XVI <- read_csv2('data/23/XVI.csv')
```
