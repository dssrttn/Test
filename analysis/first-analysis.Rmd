...
ggplot(DIL_1_MW, aes(x,y)) +
  geom_line() + 
  geom_point(size=3) + 
  labs(title="Mittelwert", #subtitle="From midwest dataset", 
      y="Dose in Grey", x="Fraction") +
...
geom_abline(intercept = 76.23, slope = 0, lty=2) + # horizontale Linie ohne Steigung, da slope = 0 
  ...
  plot.margin = margin(0, 0, 0, 1, "cm"), # Abstände um den Graphen in top-right-bottom-left Orientierung
