...
DIL<- read_csv2('data/15/DIL.csv')
Boost <- read_csv2('data/15/Boost.csv')
Rectum <- read_csv2('data/15/Rectum.csv')
Bladder <- read_csv2('data/15/Bladder.csv')
XVI <- read_csv2('data/15/XVI.csv')
```
