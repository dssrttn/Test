...
max <-max(DILtoBoost_n_mean_table$DILtoBoost_n) # _1 für 1. Fraktion
min <-min(DILtoBoost_n_mean_table$DILtoBoost_n)
...
boxplot(DILtoBoost_n_mean_table$DILtoBoost_n,
